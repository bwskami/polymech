...
import com.mss.polymech.client.renderer.item.FillingUnitItemRenderer;
...
public class FillingUnitItem extends BlockItem implements GeoItem {
    ...
    public FillingUnitItem(Block block, Properties properties) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            ...
            public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
                if (renderer == null) renderer = new FillingUnitItemRenderer();
                return renderer;
            }
        });
    }
