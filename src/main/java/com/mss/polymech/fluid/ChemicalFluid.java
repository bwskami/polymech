...
public enum ChemicalFluid implements FluidInfo {
    ...
    // ========== 气体 ==========
    HYDROGEN("hydrogen", "H2", 0xFFE8F4FF, 295, 9, 300, State.GAS, true),
    NITROGEN("nitrogen", "N2", 0xFFC0C8E0, 295, 125, 300, State.GAS, false),
    OXYGEN("oxygen", "O2", 0xFF7EB8FF, 295, 143, 300, State.GAS, false),
    CHLORINE("chlorine", "Cl2", 0xFFC0E030, 295, 321, 400, State.GAS, true),
    AMMONIA("ammonia", "NH3", 0xFF60D0E8, 295, 73, 400, State.GAS, true),
    METHANE("methane", "CH4", 0xFF90E090, 295, 72, 300, State.GAS, true),
    PROPANE("propane", "C3H8", 0xFFE0A060, 295, 188, 350, State.GAS, true),
    BUTANE("butane", "C4H10", 0xFFE07840, 295, 254, 350, State.GAS, true),
    ...
    HYDROGEN_SULFIDE("hydrogen_sulfide", "H2S", 0xFFD8D040, 295, 154, 350, State.GAS, true),
    ...
    CHLOROMETHANE("chloromethane", "CH3Cl", 0xFFC82CA0, 295, 231, 350, State.GAS, true),
    ...
    DIMETHYLAMINE("dimethylamine", "C2H7N", 0xFF554469, 295, 202, 350, State.GAS, true),
    ...
    ETHANE("ethane", "C2H6", 0xFFC8C8FF, 295, 136, 350, State.GAS, true),
    ETHYLENE("ethylene", "C2H4", 0xFFE1E1E1, 295, 126, 350, State.GAS, true),
    PROPENE("propene", "C3H6", 0xFFFFDD55, 295, 188, 350, State.GAS, true),
    BUTENE("butene", "C4H8", 0xFFCF5005, 295, 251, 350, State.GAS, true),
    BUTADIENE("butadiene", "C4H6", 0xFFB55A10, 295, 246, 350, State.GAS, true),
    CUMENE("cumene", "C9H12", 0xFF552200, 295, 400, 350, State.GAS, true),
    VINYL_CHLORIDE("vinyl_chloride", "C2H3Cl", 0xFFE1F0F0, 295, 260, 350, State.GAS, true),
    TETRAFLUOROETHYLENE("tetrafluoroethylene", "C2F4", 0xFF7D7D7D, 295, 430, 350, State.GAS, true),
    DIMETHYLDICHLOROSILANE("dimethyldichlorosilane", "C2H6Cl2Si", 0xFF441650, 295, 530, 350, State.GAS, true),
    EPICHLOROHYDRIN("epichlorohydrin", "C3H5ClO", 0xFF712400, 295, 1180, 1100, State.LIQUID, true),
    HYDROGEN_CYANIDE("hydrogen_cyanide", "HCN", 0xFF72DBD4, 295, 122, 350, State.GAS, true),
    ...
    NITROGEN_DIOXIDE("nitrogen_dioxide", "NO2", 0xFF85FCFF, 295, 205, 350, State.GAS, true),
    NITROUS_OXIDE("nitrous_oxide", "N2O", 0xFF7DC8FF, 295, 198, 350, State.GAS, false),
    DINITROGEN_TETROXIDE("dinitrogen_tetroxide", "N2O4", 0xFF004184, 295, 340, 400, State.GAS, true),
    NITROSYL_CHLORIDE("nitrosyl_chloride", "ClNO", 0xFFF3F100, 295, 287, 350, State.GAS, true),
    ...
    DEUTERIUM("deuterium", "D2", 0xFFB0C8FF, 295, 18, 300, State.GAS, true),
    TRITIUM("tritium", "T2", 0xFFFF316B, 295, 27, 300, State.GAS, true),
    ...
    NATURAL_GAS("natural_gas", "CH4", 0xFFD0E0C0, 295, 72, 300, State.GAS, true),
    COAL_GAS("coal_gas", "CO", 0xFF333333, 295, 72, 350, State.GAS, true),
    WOOD_GAS("wood_gas", "H2", 0xFFDECD87, 295, 72, 350, State.GAS, true),
    HYDRO_CRACKED_BUTADIENE("hydro_cracked_butadiene", "C4H6", 0xFFAD5203, 775, 246, 350, State.GAS, true),
    HYDRO_CRACKED_BUTANE("hydro_cracked_butane", "C4H10", 0xFF852C18, 775, 254, 350, State.GAS, true),
    HYDRO_CRACKED_BUTENE("hydro_cracked_butene", "C4H8", 0xFF993E05, 775, 251, 350, State.GAS, true),
    HYDRO_CRACKED_ETHANE("hydro_cracked_ethane", "C2H6", 0xFF9696BC, 775, 136, 350, State.GAS, true),
    HYDRO_CRACKED_ETHYLENE("hydro_cracked_ethylene", "C2H4", 0xFFA3A3A0, 775, 126, 350, State.GAS, true),
    HYDRO_CRACKED_PROPANE("hydro_cracked_propane", "C3H8", 0xFFBEA540, 775, 188, 350, State.GAS, true),
    HYDRO_CRACKED_PROPENE("hydro_cracked_propene", "C3H6", 0xFFBEA540, 775, 188, 350, State.GAS, true),
    STEAM_CRACKED_BUTADIENE("steam_cracked_butadiene", "C4H6", 0xFFAD5203, 775, 246, 350, State.GAS, true),
    STEAM_CRACKED_BUTANE("steam_cracked_butane", "C4H10", 0xFF852C18, 775, 254, 350, State.GAS, true),
    STEAM_CRACKED_BUTENE("steam_cracked_butene", "C4H8", 0xFF993E05, 775, 251, 350, State.GAS, true),
    STEAM_CRACKED_ETHANE("steam_cracked_ethane", "C2H6", 0xFF9696BC, 775, 136, 350, State.GAS, true),
    STEAM_CRACKED_ETHYLENE("steam_cracked_ethylene", "C2H4", 0xFFA3A3A0, 775, 126, 350, State.GAS, true),
    STEAM_CRACKED_PROPANE("steam_cracked_propane", "C3H8", 0xFFBEA540, 775, 188, 350, State.GAS, true),
    STEAM_CRACKED_PROPENE("steam_cracked_propene", "C3H6", 0xFFBEA540, 775, 188, 350, State.GAS, true),
    ...
    URANIUM_HEXAFLUORIDE("uranium_hexafluoride", "F6238U", 0xFF42D126, 295, 1360, 350, State.GAS, true),
    ENRICHED_URANIUM_HEXAFLUORIDE("enriched_uranium_hexafluoride", "F6235U", 0xFF4BF52A, 295, 1360, 350, State.GAS, true),
    DEPLETED_URANIUM_HEXAFLUORIDE("depleted_uranium_hexafluoride", "F6238U", 0xFF74BA66, 295, 1360, 350, State.GAS, true);
