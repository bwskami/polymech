...
/**
 * 蒸汽双联矿物跳汰机：蒸汽驱动洗选（原矿→双倍粉，耗汽更高）。
 * <p>
 * 布局：槽位 0=输入, 1=输出；储罐 0=蒸汽输入。
 * </p>
 */
public class SteamDuplexMineralJigBlockEntity extends AbstractProcessingBlockEntity implements GeoBlockEntity {
    ...
    public SteamDuplexMineralJigBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.STEAM_DUPLEX_MINERAL_JIG.get(), pos, state,
                ModRecipeTypes.STEAM_DUPLEX_MINERAL_JIG.type(), 160);
    }
