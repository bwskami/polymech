...
public final class ModVeins {
    ...
    public static final List<VeinDefinition> DEFINITIONS = List.of(
            ...
            new VeinDefinition("pyrite", 16, -50, 70, 6, 0.35F,
                    "pyrite", "pyrite", null, null,
                    IGNEOUS7),

            // ==================== 格雷独有矿物：宝石/非金属矿脉 ====================
            // 蓝宝石脉：变质岩（格雷sapphire脉：铁铝榴/蓝宝/钙铁榴/绿蓝宝）
            new VeinDefinition("sapphire", 60, -40, 0, 8, 0.25F,
                    "almandine", "sapphire", "pyrope", "green_sapphire",
                    Set.of("gneiss", "schist", "phyllite", "marble")),
            // 石榴石岩脉：变质岩（红榴/黄榴/钙铁榴/蛋白石；紫水晶另有群峦晶洞脉）
            new VeinDefinition("garnet_dike", 40, -10, 50, 9, 0.45F,
                    "red_garnet", "yellow_garnet", "andradite", "opal",
                    Set.of("schist", "gneiss", "marble")),
            // 黄玉云英岩：酸性火成岩（格雷topaz脉：蓝黄玉/黄玉/石英岩）
            new VeinDefinition("topaz_greisen", 60, -16, 32, 6, 0.25F,
                    "topaz", "blue_topaz", null, "quartzite",
                    Set.of("granite", "rhyolite", "dacite")),
            // 磷灰石脉：碳酸盐岩（格雷apatite脉：磷灰/磷酸三钙/烧绿石）
            new VeinDefinition("apatite", 40, 10, 80, 8, 0.25F,
                    "apatite", "tricalcium_phosphate", null, "pyrochlore",
                    Set.of("limestone", "marble", "claystone")),
            // 盐矿脉：沉积岩蒸发岩（格雷salts脉：岩盐/盐/锂云母/锂辉石）
            new VeinDefinition("salts", 50, 30, 70, 9, 0.2F,
                    "rock_salt", "salt", "spodumene", "lepidolite",
                    Set.of("shale", "claystone", "limestone", "chalk")),
            // 云母脉：变质岩伟晶岩（格雷mica脉：蓝晶/云母/铝土/铯榴）
            new VeinDefinition("mica", 20, -40, -10, 8, 0.25F,
                    "kyanite", "mica", "bauxite", "pollucite",
                    Set.of("gneiss", "schist", "phyllite", "quartzite")),
            // 矿砂脉：近岸沉积（格雷mineral_sand脉：玄武/花岗岩矿砂/漂白土/石膏）
            new VeinDefinition("mineral_sand", 80, 15, 60, 10, 0.2F,
                    "basaltic_mineral_sand", "granitic_mineral_sand", "fullers_earth", "gypsum",
                    Set.of("conglomerate", "shale", "claystone", "chalk")),
            // 古砂矿：砾岩（格雷garnet_tin脉：砂锡/石榴石砂/石棉/硅藻土）
            new VeinDefinition("placer", 80, 30, 60, 9, 0.4F,
                    "cassiterite_sand", "garnet_sand", "asbestos", "diatomite",
                    Set.of("conglomerate", "chert", "claystone")),
            // 油砂：沉积岩（格雷oilsands脉）
            new VeinDefinition("oilsands", 40, 30, 80, 9, 0.3F,
                    "oilsands", "oilsands", null, null,
                    Set.of("conglomerate", "shale", "claystone")),
            // 红石脉：深部变质岩（格雷redstone脉：红石/红宝石/朱砂）
            new VeinDefinition("redstone", 60, -64, -10, 9, 0.2F,
                    "redstone", "redstone", null, "cinnabar",
                    Set.of("schist", "gneiss", "phyllite", "slate")),
            // 橄榄石脉：基性岩（格雷olivine脉：橄榄/菱镁/膨润/海绿石）
            new VeinDefinition("olivine", 20, -20, 10, 8, 0.25F,
                    "olivine", "magnesite", "bentonite", "glauconite_sand",
                    Set.of("basalt", "gabbro")),
            // 滑石脉：变质碳酸盐岩（滑石/皂石/菱镁）
            new VeinDefinition("talc_vein", 30, -32, 16, 8, 0.3F,
                    "talc", "soapstone", null, "magnesite",
                    Set.of("marble", "schist", "phyllite", "dolomite")),
            // 沸石：玄武岩杏仁孔（沸石/方解石）
            new VeinDefinition("zeolite", 30, -16, 32, 6, 0.3F,
                    "zeolite", "zeolite", null, "calcite",
                    Set.of("basalt", "andesite")),
            // 明矾石：火山蚀变岩（流纹/英安岩）
            new VeinDefinition("alunite", 40, 0, 64, 6, 0.25F,
                    "alunite", "alunite", null, null,
                    Set.of("rhyolite", "dacite")),
            // 雄黄：火山热液（雄黄/硫磺）
            new VeinDefinition("realgar", 30, -32, 32, 6, 0.3F,
                    "realgar", "realgar", "sulfur", null,
                    Set.of("rhyolite", "dacite", "andesite")),
            // 重晶石：碳酸盐岩MVT伴生（重晶/方解/零星方铅）
            new VeinDefinition("barite", 40, -32, 32, 8, 0.25F,
                    "barite", "barite", "calcite", "galena",
                    Set.of("limestone", "dolomite", "shale")),
            // 针铁矿：褐铁矿风化带零星（并入地表褐铁矿脉无空位，独立小脉）
            new VeinDefinition("goethite", 60, 0, 64, 5, 0.3F,
                    "goethite", "goethite", null, "vanadium_magnetite",
                    SED8),
            // 钒磁铁矿：深部带状铁矿（磁铁矿+钒）
            new VeinDefinition("banded_iron", 40, -48, -8, 9, 0.4F,
                    "vanadium_magnetite", "magnetite", "iron", "iron",
                    Set.of("gneiss", "quartzite", "schist")),
            // 下界石英/赛特斯石英：本模组暂无下界矿脉，仅注册方块不生成
            // 钍/锂/钕/锡/铅等元素矿：作为伴生矿出现在上述各脉的sporadic/between槽位
            // 为保矿物表全量可生成，补一条深成稀有元素富集脉（花岗岩+变质岩）
            new VeinDefinition("rare_elements", 80, -64, -16, 6, 0.25F,
                    "thorium", "lithium", "neodymium", "tin",
                    Set.of("granite", "gneiss", "schist", "quartzite"))
    );
